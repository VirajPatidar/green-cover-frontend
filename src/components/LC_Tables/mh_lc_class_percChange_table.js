...
function createData(data) {
    for (const [year, y_data] of Object.entries(data)) {
        if (year != 2001) {
            var lc_perc_area_change = []
            for (const [classifi, c_value] of Object.entries(data[year])) {
                var val = data[year][classifi].percent_change
                lc_perc_area_change.push(val * -1);
            }
            rows.push({ ...lc_perc_area_change });
        }
    }
    console.log(rows);
}
...
export default function MHLCClassPercChangeTable() {
    return (
                ...
                <TableBody>
                    {rows.length > 0 && rows.map((row, key) => (
                        <StyledTableRow key={key}>
                            ...
                            <StyledTableCell align="left">{parseFloat(row[1]).toFixed(7)}&nbsp;%</StyledTableCell>
                            <StyledTableCell align="left">{parseFloat(row[2]).toFixed(7)}&nbsp;%</StyledTableCell>
                            <StyledTableCell align="left">{parseFloat(row[4]).toFixed(7)}&nbsp;%</StyledTableCell>
                            <StyledTableCell align="left">{parseFloat(row[5]).toFixed(7)}&nbsp;%</StyledTableCell>
                            <StyledTableCell align="left">{parseFloat(row[6]).toFixed(7)}&nbsp;%</StyledTableCell>
                            <StyledTableCell align="left">{parseFloat(row[7]).toFixed(7)}&nbsp;%</StyledTableCell>
                            <StyledTableCell align="left">{parseFloat(row[8]).toFixed(7)}&nbsp;%</StyledTableCell>
                            <StyledTableCell align="left">{parseFloat(row[9]).toFixed(7)}&nbsp;%</StyledTableCell>
                            <StyledTableCell align="left">{parseFloat(row[10]).toFixed(7)}&nbsp;%</StyledTableCell>
                            <StyledTableCell align="left">{parseFloat(row[11]).toFixed(7)}&nbsp;%</StyledTableCell>
                            <StyledTableCell align="left">{parseFloat(row[12]).toFixed(7)}&nbsp;%</StyledTableCell>
                            <StyledTableCell align="left">{parseFloat(row[13]).toFixed(7)}&nbsp;%</StyledTableCell>
                            <StyledTableCell align="left">{parseFloat(row[14]).toFixed(7)}&nbsp;%</StyledTableCell>
                            <StyledTableCell align="left">{parseFloat(row[16]).toFixed(7)}&nbsp;%</StyledTableCell>
                        </StyledTableRow>
                    ))}
                </TableBody>
            </Table>
